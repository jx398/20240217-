<template>
  <div class="tree-container">
    <el-row :gutter="20">
      <el-col id="xm1" :xs="24" :sm="24" :md="24" :lg="18" :xl="18">
        <el-row>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <div ref="showSelectedItems">
              <el-card>
                <el-tag class="cssShowSelected" @click="showPanding">
                  {{ showpanding ? '判定' : '关闭' }}
                </el-tag>
                <el-tag class="cssShowSelected" @click="changeAllShow">
                  {{ defaultExpanDetail ? '折叠' : '打开' }}
                </el-tag>

                <el-tag class="cssShowSelected" @click="showSelected">
                  {{ showSelec ? '显示' : '隐藏' }}
                </el-tag>
                <el-tag class="cssShowSelected" type="danger">
                  已选择项目
                  <div class="bigFont">{{ selectCount }}</div>
                  ：其中, 否决项
                  <div class="bigFont">
                    {{ foujue }}
                  </div>
                ...
                <el-tag class="cssShowSelected" type="danger">
                  总判定：
                  <div class="bigFont">{{ zhege }}</div>
                  合格
                  <div class="bigFont">{{ zjibenhege }}</div>
                  基本合格
                  <div class="bigFont">{{ zbuhege }}</div>
                  不合格
                  <div class="bigFont">{{ zbushiyong }}</div>
                  不适用
                </el-tag>
                <div v-if="showSelec" class="cssShow">
                  <span
              ...
              <div slot="header" class="Sumary" @click="changeShow('xm1')">
                ...
                <div class="rigthSum">
                  ...
                  <div class="yiji_tipPanding">
                    <el-tag type="success">{{ xm2hege }}合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm2jibenhege }}基本
                    </el-tag>

                    <el-tag type="danger">{{ xm2buhege }}不合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm2bushiyong }}不适用
                    </el-tag>

                    <el-tag type="info">{{ xm2weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm1" class="xiangmu">
                <div v-if="id2" class="id2">
                  <el-tag v-if="id2" type="danger" @click="changeShow('xm2')">
                    <div class="leftSum">2.1生产合法性</div>
                    <div class="danxiang">
                      <el-checkbox-group
            ...
            <el-card v-show="id4" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm4')">
                ...
                <div class="rigthSum">
                  ...
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm3hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm3jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm3buhege }}不合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm3bushiyong }}不适用
                    </el-tag>

                    <el-tag type="danger">{{ xm3weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm4" class="xiangmu">
                <div class="id5">
                  ...
                  >
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm3_1jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm3_1buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm3_1bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm3_1weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>
                  <div v-if="id5" id="xm5" ref="xm5" class="xiangmu">
                    <div v-if="id6" class="id6">
                      <el-tag type="success" @click="changeShow('xm6')">
                        <div class="leftSum id6">3.1.1QMS机构</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm3_1_1Panding"
                            @change="setMealSelect($event, 'xm3_1_1P', 'id6')"
                          >
                            <el-checkbox-button
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm3_1_2P', 'id7')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                  ...
                  <div v-if="id8" class="id8">
                    <el-tag v-if="id8" type="danger" @click="changeShow('xm8')">
                          ...
                          <div class="neirong">
                            <p style="height: 85px">
                              ...
                              <span class="xm3_2_2Panding_1">
                                <el-checkbox-group v-model="xm3_2_2Panding_1">
                                  ...
                                  <el-checkbox label="05">出厂检验</el-checkbox>
                          ...
                          <div class="neirong">
                            <p>
                              ...
                              <span class="xm3_2_3Panding_1">
                                <el-checkbox-group v-model="xm3_2_3Panding_1">
                                  <el-checkbox label="01">
                                    近期内审和外审的结果
                                  </el-checkbox>
                                  <el-checkbox label="02">
            ...
            <el-card v-show="id13" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm13')">
                ...
                <div class="rigthSum">
                  ...
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm4hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm4jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm4buhege }}不合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm4bushiyong }}不适用
                    </el-tag>

                    <el-tag type="danger">{{ xm4weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm13" class="xiangmu">
                <div v-if="id14" class="id14">
                  <el-tag v-if="id14" type="danger" @click="changeShow('xm14')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm4_1jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm4_1buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm4_1bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm4_1weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div v-if="id14" ref="xm14" class="xiangmu">
                    <div v-if="id15" class="id15">
                      <el-tag type="success" @click="changeShow('xm15')">
                        <div class="leftSum">4.1.1指定安标工作负责人</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm4_1_1Panding"
                            @change="setMealSelect($event, 'xm4_1_1P', 'id15')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                ...
                <div v-if="id17" class="id17">
                  <el-tag v-if="id17" type="danger" @click="changeShow('xm17')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm4_2jibenhege }}基本</el-tag>
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm4_3P', 'id20')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                          ...
                          <p>
                            ...
                            <span class="xm4_3Panding_1">
                              <el-checkbox-group v-model="xm4_3Panding_1">
                                <el-checkbox label="01">质量负责人</el-checkbox>
                                <el-checkbox label="02">检验人员</el-checkbox>
                                <el-checkbox label="03">
                                  不合格品处置负责人
                                </el-checkbox>
                              </el-checkbox-group>
            ...
            <el-card v-show="id21" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm21')">
                ...
                <div class="rigthSum">
                  ...
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm5hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm5jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm5buhege }}不合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm5bushiyong }}不适用
                    </el-tag>

                    <el-tag type="danger">{{ xm5weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm21" class="xiangmu">
                <div v-if="id22" class="id22">
                  <el-tag v-if="id22" type="danger" @click="changeShow('xm22')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm5_1jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm5_1buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm5_1bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm5_1weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div v-if="id22" ref="xm22" class="xiangmu">
                    <div v-if="id23" class="id23">
                      <el-tag type="success" @click="changeShow('xm23')">
                        <div class="leftSum">5.1.1了解产品特殊要求</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm5_1_1Panding"
                            @change="setMealSelect($event, 'xm5_1_1P', 'id23')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      <el-tag type="success" @click="changeShow('xm24')">
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm5_1_2P', 'id24')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                ...
                <div v-if="id25" class="id25">
                  <el-tag v-if="id25" type="danger" @click="changeShow('xm25')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm5_2jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm5_2buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm5_2bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm5_2weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div v-if="id25" ref="xm25" class="xiangmu">
                    <div v-if="id26" class="id26">
                      <el-tag type="success" @click="changeShow('xm26')">
                        <div class="leftSum">5.2.1 掌握产品标准及要求</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm5_2_1Panding"
                            @change="setMealSelect($event, 'xm5_2_1P', 'id26')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_2_1Panding_4">
                                <el-checkbox-group v-model="xm5_2_1Panding_4">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                  <el-checkbox label="02">车间讲解</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                            <p>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_2_1Panding_13">
                                <el-checkbox-group v-model="xm5_2_1Panding_13">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                  <el-checkbox label="02">车间讲解</el-checkbox>
                                </el-checkbox-group>
                              </span>
                    ...
                    <div v-if="id27" class="id27">
                      <el-tag type="success" @click="changeShow('xm27')">
                        <div class="leftSum">5.2.2技术人员是否为全职人员</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm5_2_2Panding"
                            @change="setMealSelect($event, 'xm5_2_2P', 'id27')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                ...
                <div v-if="id28" class="id28">
                  <el-tag v-if="id28" type="danger" @click="changeShow('xm28')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm5_3jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm5_3buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm5_3bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm5_3weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div v-if="id28" ref="xm28" class="xiangmu">
                    <div v-if="id29" class="id29">
                      <el-tag type="success" @click="changeShow('xm29')">
                        <div class="leftSum">5.3.1熟悉生产工艺</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm5_3_1Panding"
                            @change="setMealSelect($event, 'xm5_3_1P', 'id29')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_3_1Panding_4">
                                <el-checkbox-group v-model="xm5_3_1Panding_4">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_3_2Panding_4">
                                <el-checkbox-group v-model="xm5_3_2Panding_4">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                  <el-checkbox label="02">现场操作</el-checkbox>
                                  <el-checkbox label="03">模拟操作</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                ...
                <div v-if="id31" class="id31">
                  <el-tag v-if="id31" type="danger" @click="changeShow('xm31')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm5_4jibenhege }}基本</el-tag>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_4_1Panding_4">
                                <el-checkbox-group v-model="xm5_4_1Panding_4">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_4_1Panding_7">
                                <el-checkbox-group v-model="xm5_4_1Panding_7">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_4_1Panding_11">
                                <el-checkbox-group v-model="xm5_4_1Panding_11">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_4_2Panding_3">
                                <el-checkbox-group v-model="xm5_4_2Panding_3">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                  <el-checkbox label="02">现场操作</el-checkbox>
                                  <el-checkbox label="03">模拟操作</el-checkbox>
                                </el-checkbox-group>
                          ...
                          <el-card shadow="never">
                            ...
                            <p>
                              ...
                              <span class="xm5_4_2Panding_6">
                                <el-checkbox-group v-model="xm5_4_2Panding_6">
                                  <el-checkbox label="01">技术交流</el-checkbox>
                                  <el-checkbox label="02">现场操作</el-checkbox>
                                  <el-checkbox label="03">现场操作</el-checkbox>
                                </el-checkbox-group>
                              </span>
                            </p>
                ...
                <div v-if="id34" class="id34">
                  <el-tag v-if="id34" type="danger" @click="changeShow('xm34')">
            ...
            <el-card v-show="id35" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm35')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm6hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm6jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm6buhege }}不合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm6bushiyong }}不适用
                    </el-tag>

                    <el-tag type="danger">{{ xm6weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm35" class="xiangmu">
                <div v-if="id36" class="id36">
                  <el-tag type="success" @click="changeShow('xm36')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm6_1jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm6_1buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm6_1bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm6_1weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm36" class="xiangmu">
                    <div v-if="id37" class="id37">
                      <el-tag
                        v-if="id37"
                        type="danger"
                        @click="changeShow('xm37')"
                      >
                        <div class="leftSum id37">6.1.1建立文件管理制度</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm6_1_1Panding"
                            @change="setMealSelect($event, 'xm6_1_1P', 'id37')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm6_1_2P', 'id38')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm6_1_3P', 'id39')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm6_1_4P', 'id40')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                  ...
                  <el-tag type="success" @click="changeShow('xm41')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm6_2jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm6_2buhege }}不合格</el-tag>

                        <el-tag v-if="hide_panding" type="danger">
                          {{ xm6_2bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm6_2weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm41" class="xiangmu">
                    <div v-if="id42" class="id42">
                      <el-tag
                        v-if="id42"
                        type="danger"
                        @click="changeShow('xm42')"
                      >
                        <div class="leftSum id42">6.2.1建立记录管理制度</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm6_2_1Panding"
                            @change="setMealSelect($event, 'xm6_2_1P', 'id42')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm6_2_2P', 'id43')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                          ...
                          <p style="height: 120px">
                            ...
                            <span class="xm6_2_2Panding_1">
                              <el-checkbox-group v-model="xm6_2_2Panding_1">
                                ...
                                <el-checkbox label="06">培训记录</el-checkbox>
                                <el-checkbox label="07">
                                  技术文件（图纸、工艺等）更改记录
                                </el-checkbox>
                                ...
                                <el-checkbox label="12">供方评价</el-checkbox>
                                <el-checkbox label="13">销售台账</el-checkbox>
            ...
            <el-card v-show="id44" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm44')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm7hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm7jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm7buhege }}不合格</el-tag>

                    <el-tag type="danger">{{ xm7bushiyong }}不适用</el-tag>

                    <el-tag type="danger">{{ xm7weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm44" class="xiangmu">
                <div v-if="id45" class="id45">
                  <el-tag type="success" @click="changeShow('xm45')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm7_1jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm7_1buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm7_1bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm7_1weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm45" class="xiangmu">
                    <div v-if="id46" class="id46">
                      <el-tag
                        v-if="id46"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_1_1P', 'id46')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_1_2P', 'id47')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_1_3P', 'id48')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_1_4P', 'id49')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                    ...
                    <div v-if="id50" class="id50">
                      <el-tag
                        v-if="id50"
                        type="danger"
                        @click="changeShow('xm50')"
                      >
                        <div class="leftSum id50">7.1.5采购品检验合格证</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm7_1_5Panding"
                            @change="setMealSelect($event, 'xm7_1_5P', 'id50')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      <div ref="xm50" class="xiangmu">
                        <div class="neirong">
                          ...
                          <p style="color: gray">产品一致性核查情况见附件5</p>
                        </div>
                      </div>
                    </div>
                    <div v-if="id51" class="id51">
                      <el-tag
                        v-if="id51"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_1_6P', 'id51')"
                          >
                            <el-checkbox-button
                  ...
                  <el-tag type="success" @click="changeShow('xm52')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm7_2jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm7_2buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm7_2bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm7_2weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm52" class="xiangmu">
                    <div v-if="id53" class="id53">
                      <el-tag
                        v-if="id53"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_2_1P', 'id53')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_2_2P', 'id54')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_2_3P', 'id55')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_2_4P', 'id56')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_2_5P', 'id57')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                    ...
                    <div v-if="id58" class="id58">
                      <el-tag
                        v-if="id58"
                        type="danger"
                        @click="changeShow('xm58')"
                      >
                        <div class="leftSum id58">7.2.6外协件检验合格证明</div>

                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm7_2_6Panding"
                            @change="setMealSelect($event, 'xm7_2_6P', 'id58')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm7_2_7P', 'id59')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
            ...
            <el-card v-show="id60" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm60')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm8hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm8jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm8buhege }}不合格</el-tag>

                    <el-tag type="danger">{{ xm8bushiyong }}不适用</el-tag>

                    <el-tag type="danger">{{ xm8weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm60" class="xiangmu">
                <div v-if="id61" class="id61">
                  <el-tag type="success" @click="changeShow('xm61')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm8_1jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm8_1buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm8_1bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm8_1weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm61" class="xiangmu">
                    <div v-if="id62" class="id62">
                      <el-tag
                        v-if="id62"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_1_1P', 'id62')"
                          >
                            <el-checkbox-button
                              v-for="option in twoOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_1_2P', 'id63')"
                          >
                            <el-checkbox-button
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_1_3P', 'id64')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                  ...
                  <el-tag type="success" @click="changeShow('xm65')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm8_2jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm8_2buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm8_2bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm8_2weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm65" class="xiangmu">
                    <div v-if="id66" class="id66">
                      <el-tag
                        v-if="id66"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_2_1P', 'id66')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                    ...
                    <div v-if="id67" class="id67">
                      <el-tag
                        v-if="id67"
                        type="danger"
                        @click="changeShow('xm67')"
                      >
                        <div class="leftSum id67">8.2.2重要设备操作规程</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm8_2_2Panding"
                            @change="setMealSelect($event, 'xm8_2_2P', 'id67')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_2_3P', 'id68')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_2_4P', 'id69')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                          ...
                          <p>
                            ...
                            <span class="xm8_2_4Panding_2">
                              <el-checkbox-group v-model="xm8_2_4Panding_2">
                                ...
                                <el-checkbox label="02">工艺过程卡</el-checkbox>
                                <el-checkbox label="03">装配工艺卡</el-checkbox>
                                <el-checkbox label="04">
                                  零件加工工艺卡
                                </el-checkbox>
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_2_5P', 'id70')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm8_2_6P', 'id71')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
            ...
            <el-card v-show="id72" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm72')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm9hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm9jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm9buhege }}不合格</el-tag>

                    <el-tag type="danger">{{ xm9bushiyong }}不适用</el-tag>

                    <el-tag type="danger">{{ xm9weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm72" class="xiangmu">
                <div v-if="id73" class="id73">
                  ...
                  <el-tag type="success" @click="changeShow('xm74')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm9_2jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm9_2buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm9_2bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm9_2weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm74" class="xiangmu">
                    <div v-if="id75" class="id75">
                      <el-tag
                        v-if="id75"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_2_1P', 'id75')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_2_2P', 'id76')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                  ...
                  <el-tag type="success" @click="changeShow('xm77')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm9_3jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm9_3buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm9_3bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm9_3weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm77" class="xiangmu">
                    <div v-if="id78" class="id78">
                      <el-tag
                        v-if="id78"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_3_1P', 'id78')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_3_2P', 'id79')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                  ...
                  <el-tag type="success" @click="changeShow('xm80')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm9_4jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm9_4buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm9_4bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm9_4weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm80" class="xiangmu">
                    <div v-if="id81" class="id81">
                      <el-tag
                        v-if="id81"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_4_1P', 'id81')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                          ...
                          <p>
                            ...
                            <span class="xm9_4_1Panding_2">
                              <el-checkbox-group v-model="xm9_4_1Panding_2">
                                ...
                                <el-checkbox label="02">检验项目</el-checkbox>
                                <el-checkbox label="03">检验方法</el-checkbox>
                                <el-checkbox label="04">
                                  检测检验设备
                                </el-checkbox>
                                <el-checkbox label="05">
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_4_2P', 'id82')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                    ...
                    <div v-if="id83" class="id83">
                      <el-tag
                        v-if="id83"
                        type="danger"
                        @click="changeShow('xm83')"
                      >
                        <div class="leftSum id83">9.4.3关键工序检验规程</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm9_4_3Panding"
                            @change="setMealSelect($event, 'xm9_4_3P', 'id83')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_4_4P', 'id84')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                  ...
                  <el-tag type="success" @click="changeShow('xm86')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm9_6jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm9_6buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm9_6bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm9_6weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm86" class="xiangmu">
                    <div v-if="id87" class="id87">
                      <el-tag
                        v-if="id87"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_6_1P', 'id87')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_6_2P', 'id88')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_6_3P', 'id89')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                    ...
                    <div v-if="id90" class="id90">
                      <el-tag
                        v-if="id90"
                        type="danger"
                        @click="changeShow('xm90')"
                      >
                        <div class="leftSum id90">9.6.4检测结果追溯评定</div>
                        <div class="danxiang">
                          <el-checkbox-group
                            v-model="xm9_6_4Panding"
                            @change="setMealSelect($event, 'xm9_6_4P', 'id90')"
                          >
                            <el-checkbox-button
                              v-for="option in fourOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_6_5P', 'id91')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                  ...
                  <el-tag type="success" @click="changeShow('xm92')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm9_7jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm9_7buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm9_7bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm9_7weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>

                  <div ref="xm92" class="xiangmu">
                    <div v-if="id93" class="id93">
                      <el-tag
                        v-if="id93"
                        type="danger"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_7_1P', 'id93')"
                          >
                            <el-checkbox-button
                              v-for="option in twoOptions"
                              :key="option"
                      ...
                      >
                        ...
                        <div class="danxiang">
                          <el-checkbox-group
                            ...
                            @change="setMealSelect($event, 'xm9_7_2P', 'id94')"
                          >
                            <el-checkbox-button
                              v-for="option in threeOptions"
                              :key="option"
                          ...
                          <p>
                            ...
                            <span class="xm9_7_2Panding_1">
                              <el-checkbox-group v-model="xm9_7_2Panding_1">
                                <el-checkbox label="01">产品名称</el-checkbox>
                                <el-checkbox label="02">型号规格</el-checkbox>
                                <el-checkbox label="03">产品编号</el-checkbox>
                                <el-checkbox label="04">检验依据</el-checkbox>
                                <el-checkbox label="05">项目</el-checkbox>
                                <el-checkbox label="06">技术要求</el-checkbox>
                                <el-checkbox label="07">实测结果</el-checkbox>
                                <el-checkbox label="08">检验结论</el-checkbox>
            ...
            <el-card v-show="id96" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm96')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm10hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm10jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm10buhege }}不合格</el-tag>

                    <el-tag type="danger">{{ xm10bushiyong }}不适用</el-tag>

                    <el-tag type="danger">{{ xm10weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm96" class="xiangmu">
                <div v-if="id97" class="id97">
                      ...
                      <p>
                        ...
                        <span class="xm10_1Panding_2">
                          <el-checkbox-group v-model="xm10_1Panding_2">
                            <el-checkbox label="01">不合格品识别</el-checkbox>
                            <el-checkbox label="02">不合格品评定</el-checkbox>
                            <el-checkbox label="03">不合格品记录</el-checkbox>
                            <el-checkbox label="04">
                              不合格品处置的职责权限
                            </el-checkbox>
                          </el-checkbox-group>
                      ...
                      <p>
                        ...
                        <span class="xm10_5Panding_3">
                          <el-checkbox-group v-model="xm10_5Panding_3">
                            ...
                            <el-checkbox label="02">产品客户信息</el-checkbox>
                            <el-checkbox label="03">
                              通知客户采取的措施
                            </el-checkbox>
                            <el-checkbox label="04">
        ...
        <el-row>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-card v-show="id102" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm102')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm11hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm11jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm11buhege }}不合格</el-tag>

                    <el-tag type="danger">{{ xm11bushiyong }}不适用</el-tag>

                    <el-tag type="danger">{{ xm11weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm102" class="xiangmu">
                <div v-if="id103" class="id103">
                ...
                <div v-if="id104" class="id104">
                  <el-tag type="success" @click="changeShow('xm104')">
                    <div class="leftSum id104">11.2产品一致性控制</div>
                    <div class="danxiang">
                      <el-checkbox-group
        ...
        <el-row>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-card v-show="id106" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm106')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm12hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm12jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm12buhege }}不合格</el-tag>

                    <el-tag type="danger">{{ xm12bushiyong }}不适用</el-tag>

                    <el-tag type="danger">{{ xm12weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm106" class="xiangmu">
                <div v-if="id107" class="id107">
                  ...
                  <el-tag type="success" @click="changeShow('xm108')">
                    ...
                    <div class="secondDanxiang">
                      ...
                      <div class="tipPanding">
                        ...
                        <el-tag type="danger">{{ xm12_2jibenhege }}基本</el-tag>

                        <el-tag type="danger">{{ xm12_2buhege }}不合格</el-tag>

                        <el-tag type="danger">
                          {{ xm12_2bushiyong }}不适用
                        </el-tag>

                        <el-tag type="danger">{{ xm12_2weipan }}未判定</el-tag>
                      </div>
                    </div>
                  </el-tag>
                  <div ref="xm108" class="xiangmu">
                    <div v-if="id109" class="id109">
                      <el-tag
                        v-if="id109"
                        type="danger"
                        @click="changeShow('xm109')"
                      >
                        <div class="leftSum id109">12.2.1分类存放并标识</div>
                        <div class="danxiang">
                          <el-checkbox-group
        ...
        <el-row>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-card v-show="id112" class="icon-panel">
              <div slot="header" class="Sumary" @click="changeShow('xm112')">
                ...
                <div class="rigthSum">
                  ...
                  项。
                  <div class="yiji_tipPanding">
                    <el-tag type="danger">{{ xm13hege }}合格</el-tag>

                    <el-tag type="danger">{{ xm13jibenhege }}基本</el-tag>

                    <el-tag type="danger">{{ xm13buhege }}不合格</el-tag>

                    <el-tag v-if="hide_panding" type="danger">
                      {{ xm13bushiyong }}不适用
                    </el-tag>

                    <el-tag type="danger">{{ xm13weipan }}未判定</el-tag>
                  </div>
                </div>
              </div>
              <span></span>
              <div ref="xm112" class="xiangmu">
                <div v-if="id113" class="id113">
                ...
                <div v-if="id115" class="id115">
                  <el-tag type="success" @click="changeShow('xm115')">
                    <div class="leftSum id115">13.3禁止加施标识</div>
                    <div class="danxiang">
                      <el-checkbox-group
          ...
          <el-card shadow="never">
            <div slot="header">
              <div class="use-flexbox">
                ...
                <el-button type="primary" @click="baogao">生成报告</el-button>
                <el-button type="primary">生成报告</el-button>
              </div>
              <el-divider content-position="left">
                <span @click="changeShow('xm-0')">评审内容</span>
              </el-divider>
              <div class="use-flexbox">
                ...
                <span>
                  ...
                  <el-checkbox disabled>收起</el-checkbox>
                </span>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      jiaoyan() {
        console.log(this.xm2_1Panding_1)
      },
      baogao() {
        console.log('baogao')
        $.ajax({
          ...
          url: 'http://117.160.199.82:7777/anbiao_bg.ashx', //请求地址
          data: JSON.stringify({
            xm2_1Panding_1: this.xm2_1Panding_1,
            xm2_1Panding_2: this.xm2_1Panding_2,
            xm2_1Panding_3: this.xm2_1Panding_3,
            xm2_1Panding_4: this.xm2_1Panding_4,
            xm2_2Panding_1: this.xm2_2Panding_1,
            xm2_2Panding_2: this.xm2_2Panding_2,
            xm2_2Panding_3: this.xm2_2Panding_3,
            xm2_2Panding_4: this.xm2_2Panding_4,
            xm2_2Panding_5: this.xm2_2Panding_5,
            xm2_2Panding_6: this.xm2_2Panding_6,
            xm3_1_1Panding_1: this.xm3_1_1Panding_1,
            xm3_1_1Panding_2: this.xm3_1_1Panding_2,
            xm3_1_1Panding_3: this.xm3_1_1Panding_3,
            xm3_1_2Panding_1: this.xm3_1_2Panding_1,
            xm3_1_2Panding_2: this.xm3_1_2Panding_2,
            xm3_1_2Panding_3: this.xm3_1_2Panding_3,
            xm3_1_2Panding_4: this.xm3_1_2Panding_4,
            xm3_2_1Panding_1: this.xm3_2_1Panding_1,
            xm3_2_1Panding_2: this.xm3_2_1Panding_2,
            xm3_2_1Panding_3: this.xm3_2_1Panding_3,
            xm3_2_1Panding_4: this.xm3_2_1Panding_4,
            xm3_2_1Panding_5: this.xm3_2_1Panding_5,
            xm3_2_1Panding_6: this.xm3_2_1Panding_6,
            xm3_2_1Panding_7: this.xm3_2_1Panding_7,
            xm3_2_1Panding_8: this.xm3_2_1Panding_8,
            xm3_2_1Panding_9: this.xm3_2_1Panding_9,
            xm3_2_2Panding_1: this.xm3_2_2Panding_1.join(','),
            xm3_2_2Panding_2: this.xm3_2_2Panding_2,
            xm3_2_2Panding_3: this.xm3_2_2Panding_3,
            xm3_2_2Panding_4: this.xm3_2_2Panding_4,
            xm3_2_2Panding_5: this.xm3_2_2Panding_5,
            xm3_2_2Panding_6: this.xm3_2_2Panding_6,
            xm3_2_3Panding_1: this.xm3_2_3Panding_1.join(','),
            xm3_2_3Panding_2: this.xm3_2_3Panding_2,
            xm3_2_3Panding_3: this.xm3_2_3Panding_3,
            xm3_2_4Panding_1: this.xm3_2_4Panding_1,
            xm3_2_4Panding_2: this.xm3_2_4Panding_2,
            xm4_1_1Panding_1: this.xm4_1_1Panding_1,
            xm4_1_1Panding_2: this.xm4_1_1Panding_2,
            xm4_1_1Panding_3: this.xm4_1_1Panding_3,
            xm4_1_1Panding_4: this.xm4_1_1Panding_4,
            xm4_1_1Panding_5: this.xm4_1_1Panding_5,
            xm4_1_1Panding_6: this.xm4_1_1Panding_6,
            xm4_1_1Panding_7: this.xm4_1_1Panding_7.join(','),
            xm4_1_1Panding_8: this.xm4_1_1Panding_8,
            xm4_1_2Panding_1: this.xm4_1_2Panding_1,
            xm4_1_2Panding_2: this.xm4_1_2Panding_2,
            xm4_2_1Panding_1: this.xm4_2_1Panding_1,
            xm4_2_1Panding_2: this.xm4_2_1Panding_2,
            xm4_2_1Panding_3: this.xm4_2_1Panding_3,
            xm4_2_1Panding_4: this.xm4_2_1Panding_4,
            xm4_2_1Panding_5: this.xm4_2_1Panding_5,
            xm4_2_1Panding_6: this.xm4_2_1Panding_6,
            xm4_2_1Panding_7: this.xm4_2_1Panding_7.join(','),
            xm4_2_1Panding_8: this.xm4_2_1Panding_8,
            xm4_2_2Panding_1: this.xm4_2_2Panding_1,
            xm4_2_2Panding_2: this.xm4_2_2Panding_2,
            xm4_3Panding_1: this.xm4_3Panding_1.join(','),
            xm4_3Panding_2: this.xm4_3Panding_2,
            xm4_3Panding_3: this.xm4_3Panding_3,
            xm4_3Panding_4: this.xm4_3Panding_4,
            xm4_3Panding_5: this.xm4_3Panding_5,
            xm4_3Panding_6: this.xm4_3Panding_6,
            xm4_3Panding_7: this.xm4_3Panding_7,
            xm4_3Panding_8: this.xm4_3Panding_8,
            xm4_3Panding_9: this.xm4_3Panding_9,
            xm4_3Panding_10: this.xm4_3Panding_10,
            xm4_3Panding_11: this.xm4_3Panding_11,
            xm4_3Panding_12: this.xm4_3Panding_12,
            xm5_1_1Panding_1: this.xm5_1_1Panding_1,
            xm5_1_1Panding_2: this.xm5_1_1Panding_2,
            xm5_1_1Panding_3: this.xm5_1_1Panding_3,
            xm5_1_1Panding_4: this.xm5_1_1Panding_4,
            xm5_1_2Panding_1: this.xm5_1_2Panding_1,
            xm5_1_2Panding_2: this.xm5_1_2Panding_2,
            xm5_1_2Panding_3: this.xm5_1_2Panding_3,
            xm5_1_2Panding_4: this.xm5_1_2Panding_4,
            xm5_1_2Panding_5: this.xm5_1_2Panding_5,
            xm5_1_2Panding_6: this.xm5_1_2Panding_6,
            xm5_1_2Panding_7: this.xm5_1_2Panding_7,
            xm5_1_2Panding_8: this.xm5_1_2Panding_8,
            xm5_2_1Panding_1: this.xm5_2_1Panding_1,
            xm5_2_1Panding_2: this.xm5_2_1Panding_2,
            xm5_2_1Panding_3: this.xm5_2_1Panding_3,
            xm5_2_1Panding_4: this.xm5_2_1Panding_4.join(','),
            xm5_2_1Panding_5: this.xm5_2_1Panding_5,
            xm5_2_1Panding_6: this.xm5_2_1Panding_6,
            xm5_2_1Panding_7: this.xm5_2_1Panding_7,
            xm5_2_1Panding_8: this.xm5_2_1Panding_8,
            xm5_2_1Panding_9: this.xm5_2_1Panding_9,
            xm5_2_1Panding_10: this.xm5_2_1Panding_10,
            xm5_2_1Panding_11: this.xm5_2_1Panding_11,
            xm5_2_1Panding_12: this.xm5_2_1Panding_12,
            xm5_2_1Panding_13: this.xm5_2_1Panding_13.join(','),
            xm5_2_1Panding_14: this.xm5_2_1Panding_14,
            xm5_2_1Panding_15: this.xm5_2_1Panding_15,
            xm5_2_1Panding_16: this.xm5_2_1Panding_16,
            xm5_2_1Panding_17: this.xm5_2_1Panding_17,
            xm5_2_1Panding_18: this.xm5_2_1Panding_18,
            xm5_2_1Panding_19: this.xm5_2_1Panding_19,
            xm5_2_1Panding_20: this.xm5_2_1Panding_20,
            xm5_2_2Panding_1: this.xm5_2_2Panding_1,
            xm5_2_2Panding_2: this.xm5_2_2Panding_2,
            xm5_2_2Panding_3: this.xm5_2_2Panding_3,
            xm5_3_1Panding_1: this.xm5_3_1Panding_1,
            xm5_3_1Panding_2: this.xm5_3_1Panding_2,
            xm5_3_1Panding_3: this.xm5_3_1Panding_3,
            xm5_3_1Panding_4: this.xm5_3_1Panding_4,
            xm5_3_1Panding_5: this.xm5_3_1Panding_5,
            xm5_3_1Panding_6: this.xm5_3_1Panding_6,
            xm5_3_1Panding_7: this.xm5_3_1Panding_7,
            xm5_3_2Panding_1: this.xm5_3_2Panding_1,
            xm5_3_2Panding_2: this.xm5_3_2Panding_2,
            xm5_3_2Panding_3: this.xm5_3_2Panding_3,
            xm5_3_2Panding_4: this.xm5_3_2Panding_4.join(','),
            xm5_3_2Panding_5: this.xm5_3_2Panding_5,
            xm5_3_2Panding_6: this.xm5_3_2Panding_6,
            xm5_3_2Panding_7: this.xm5_3_2Panding_7,
            xm5_4_1Panding_1: this.xm5_4_1Panding_1,
            xm5_4_1Panding_2: this.xm5_4_1Panding_2,
            xm5_4_1Panding_3: this.xm5_4_1Panding_3,
            xm5_4_1Panding_4: this.xm5_4_1Panding_4,
            xm5_4_1Panding_5: this.xm5_4_1Panding_5,
            xm5_4_1Panding_6: this.xm5_4_1Panding_6,
            xm5_4_1Panding_7: this.xm5_4_1Panding_7,
            xm5_4_1Panding_8: this.xm5_4_1Panding_8,
            xm5_4_1Panding_9: this.xm5_4_1Panding_9,
            xm5_4_1Panding_10: this.xm5_4_1Panding_10,
            xm5_4_1Panding_11: this.xm5_4_1Panding_11,
            xm5_4_1Panding_12: this.xm5_4_1Panding_12,
            xm5_4_1Panding_13: this.xm5_4_1Panding_13,
            xm5_4_1Panding_14: this.xm5_4_1Panding_14,
            xm5_4_2Panding_1: this.xm5_4_2Panding_1,
            xm5_4_2Panding_2: this.xm5_4_2Panding_2,
            xm5_4_2Panding_3: this.xm5_4_2Panding_3.join(','),
            xm5_4_2Panding_4: this.xm5_4_2Panding_4,
            xm5_4_2Panding_5: this.xm5_4_2Panding_5,
            xm5_4_2Panding_6: this.xm5_4_2Panding_6.join(','),
            xm5_4_2Panding_7: this.xm5_4_2Panding_7,
            xm5_4_2Panding_8: this.xm5_4_2Panding_8,
            xm5_4_2Panding_9: this.xm5_4_2Panding_9.join(','),
            xm5_4_2Panding_10: this.xm5_4_2Panding_10,
            xm5_4_2Panding_11: this.xm5_4_2Panding_11,
            xm5_5Panding_1: this.xm5_5Panding_1,
            xm5_5Panding_2: this.xm5_5Panding_2,
            xm5_5Panding_3: this.xm5_5Panding_3,
            xm6_1_1Panding_1: this.xm6_1_1Panding_1,
            xm6_1_1Panding_2: this.xm6_1_1Panding_2,
            xm6_1_1Panding_3: this.xm6_1_1Panding_3,
            xm6_1_1Panding_4: this.xm6_1_1Panding_4,
            xm6_1_1Panding_5: this.xm6_1_1Panding_5,
            xm6_1_2Panding_1: this.xm6_1_2Panding_1,
            xm6_1_2Panding_2: this.xm6_1_2Panding_2,
            xm6_1_2Panding_3: this.xm6_1_2Panding_3,
            xm6_1_2Panding_4: this.xm6_1_2Panding_4,
            xm6_1_2Panding_5: this.xm6_1_2Panding_5,
            xm6_1_2Panding_6: this.xm6_1_2Panding_6,
            xm6_1_2Panding_7: this.xm6_1_2Panding_7,
            xm6_1_2Panding_8: this.xm6_1_2Panding_8,
            xm6_1_2Panding_9: this.xm6_1_2Panding_9,
            xm6_1_2Panding_10: this.xm6_1_2Panding_10,
            xm6_1_3Panding_1: this.xm6_1_3Panding_1,
            xm6_1_3Panding_2: this.xm6_1_3Panding_2,
            xm6_1_3Panding_3: this.xm6_1_3Panding_3,
            xm6_1_3Panding_4: this.xm6_1_3Panding_4,
            xm6_1_3Panding_5: this.xm6_1_3Panding_5,
            xm6_1_3Panding_6: this.xm6_1_3Panding_6,
            xm6_1_4Panding_1: this.xm6_1_4Panding_1.join(','),
            xm6_1_4Panding_2: this.xm6_1_4Panding_2,
            xm6_2_1Panding_1: this.xm6_2_1Panding_1,
            xm6_2_1Panding_2: this.xm6_2_1Panding_2,
            xm6_2_1Panding_3: this.xm6_2_1Panding_3,
            xm6_2_1Panding_4: this.xm6_2_1Panding_4,
            xm6_2_1Panding_5: this.xm6_2_1Panding_5,
            xm6_2_1Panding_6: this.xm6_2_1Panding_6,
            xm6_2_1Panding_7: this.xm6_2_1Panding_7,
            xm6_2_1Panding_8: this.xm6_2_1Panding_8,
            xm6_2_2Panding_1: this.xm6_2_2Panding_1.join(','),
            xm6_2_2Panding_2: this.xm6_2_2Panding_2,
            xm6_2_2Panding_3: this.xm6_2_2Panding_3,
            xm6_2_2Panding_4: this.xm6_2_2Panding_4,
            xm6_2_2Panding_5: this.xm6_2_2Panding_5,
            xm7_1_1Panding_1: this.xm7_1_1Panding_1,
            xm7_1_1Panding_2: this.xm7_1_1Panding_2,
            xm7_1_1Panding_3: this.xm7_1_1Panding_3,
            xm7_1_1Panding_4: this.xm7_1_1Panding_4.join(','),
            xm7_1_1Panding_5: this.xm7_1_1Panding_5,
            xm12_2_1Panding_2: this.xm12_2_1Panding_2,
            xm12_2_2Panding_1: this.xm12_2_2Panding_1,
            xm12_2_2Panding_2: this.xm12_2_2Panding_2,
            xm12_2_2Panding_3: this.xm12_2_2Panding_3,
            xm12_2_2Panding_4: this.xm12_2_2Panding_4,
            xm12_3Panding_1: this.xm12_3Panding_1,
            xm12_3Panding_2: this.xm12_3Panding_2,
            xm12_3Panding_3: this.xm12_3Panding_3,
            xm13_1Panding_1: this.xm13_1Panding_1,
            xm13_1Panding_2: this.xm13_1Panding_2,
            xm13_2Panding_1: this.xm13_2Panding_1,
            xm13_2Panding_2: this.xm13_2Panding_2,
            xm13_2Panding_3: this.xm13_2Panding_3,
            xm13_3Panding_1: this.xm13_3Panding_1.join(','),
            xm13_3Panding_2: this.xm13_3Panding_2,

            xm2_1Panding: this.xm2_1Panding.join(','),
            xm2_2Panding: this.xm2_2Panding.join(','),
            xm3_1_1Panding: this.xm3_1_1Panding.join(','),
            xm3_1_2Panding: this.xm3_1_2Panding.join(','),
            xm3_2_1Panding: this.xm3_2_1Panding.join(','),
            xm3_2_2Panding: this.xm3_2_2Panding.join(','),
            xm3_2_3Panding: this.xm3_2_3Panding.join(','),
            xm3_2_4Panding: this.xm3_2_4Panding.join(','),
            xm4_1_1Panding: this.xm4_1_1Panding.join(','),
            xm4_1_2Panding: this.xm4_1_2Panding.join(','),
            xm4_2_1Panding: this.xm4_2_1Panding.join(','),
            xm4_2_2Panding: this.xm4_2_2Panding.join(','),
            xm4_3Panding: this.xm4_3Panding.join(','),
            xm5_1_1Panding: this.xm5_1_1Panding.join(','),
            xm5_1_2Panding: this.xm5_1_2Panding.join(','),
            xm5_2_1Panding: this.xm5_2_1Panding.join(','),
            xm5_2_2Panding: this.xm5_2_2Panding.join(','),
            xm5_3_1Panding: this.xm5_3_1Panding.join(','),
            xm5_3_2Panding: this.xm5_3_2Panding.join(','),
            xm5_4_1Panding: this.xm5_4_1Panding.join(','),
            xm5_4_2Panding: this.xm5_4_2Panding.join(','),
            xm5_5Panding: this.xm5_5Panding.join(','),
            xm6_1_1Panding: this.xm6_1_1Panding.join(','),
            xm6_1_2Panding: this.xm6_1_2Panding.join(','),
            xm6_1_3Panding: this.xm6_1_3Panding.join(','),
            xm6_1_4Panding: this.xm6_1_4Panding.join(','),
            xm6_2_1Panding: this.xm6_2_1Panding.join(','),
            xm6_2_2Panding: this.xm6_2_2Panding.join(','),
            xm7_1_1Panding: this.xm7_1_1Panding.join(','),
            xm7_1_2Panding: this.xm7_1_2Panding.join(','),
            xm7_1_3Panding: this.xm7_1_3Panding.join(','),
            xm7_1_4Panding: this.xm7_1_4Panding.join(','),
            xm7_1_5Panding: this.xm7_1_5Panding.join(','),
            xm7_1_6Panding: this.xm7_1_6Panding.join(','),
            xm7_2_1Panding: this.xm7_2_1Panding.join(','),
            xm7_2_2Panding: this.xm7_2_2Panding.join(','),
            xm7_2_3Panding: this.xm7_2_3Panding.join(','),
            xm7_2_4Panding: this.xm7_2_4Panding.join(','),
            xm7_2_5Panding: this.xm7_2_5Panding.join(','),
            xm7_2_6Panding: this.xm7_2_6Panding.join(','),
            xm7_2_7Panding: this.xm7_2_7Panding.join(','),
            xm8_1_1Panding: this.xm8_1_1Panding.join(','),
            xm8_1_2Panding: this.xm8_1_2Panding.join(','),
            xm8_1_3Panding: this.xm8_1_3Panding.join(','),
            xm8_2_1Panding: this.xm8_2_1Panding.join(','),
            xm8_2_2Panding: this.xm8_2_2Panding.join(','),
            xm8_2_3Panding: this.xm8_2_3Panding.join(','),
            xm8_2_4Panding: this.xm8_2_4Panding.join(','),
            xm8_2_5Panding: this.xm8_2_5Panding.join(','),
            xm8_2_6Panding: this.xm8_2_6Panding.join(','),
            xm9_1Panding: this.xm9_1Panding.join(','),
            xm9_2_1Panding: this.xm9_2_1Panding.join(','),
            xm9_2_2Panding: this.xm9_2_2Panding.join(','),
            xm9_3_1Panding: this.xm9_3_1Panding.join(','),
            xm9_3_2Panding: this.xm9_3_2Panding.join(','),
            xm9_4_1Panding: this.xm9_4_1Panding.join(','),
            xm9_4_2Panding: this.xm9_4_2Panding.join(','),
            xm9_4_3Panding: this.xm9_4_3Panding.join(','),
            xm9_4_4Panding: this.xm9_4_4Panding.join(','),
            xm9_5Panding: this.xm9_5Panding.join(','),
            xm9_6_1Panding: this.xm9_6_1Panding.join(','),
            xm9_6_2Panding: this.xm9_6_2Panding.join(','),
            xm9_6_3Panding: this.xm9_6_3Panding.join(','),
            xm9_6_4Panding: this.xm9_6_4Panding.join(','),
            xm9_6_5Panding: this.xm9_6_5Panding.join(','),
            xm9_7_1Panding: this.xm9_7_1Panding.join(','),
            xm9_7_2Panding: this.xm9_7_2Panding.join(','),
            xm9_8Panding: this.xm9_8Panding.join(','),
            xm10_1Panding: this.xm10_1Panding.join(','),
            xm10_2Panding: this.xm10_2Panding.join(','),
            xm10_3Panding: this.xm10_3Panding.join(','),
            xm10_4Panding: this.xm10_4Panding.join(','),
            xm10_5Panding: this.xm10_5Panding.join(','),
            xm11_1Panding: this.xm11_1Panding.join(','),
            xm11_2Panding: this.xm11_2Panding.join(','),
            xm11_3Panding: this.xm11_3Panding.join(','),
            xm12_1Panding: this.xm12_1Panding.join(','),
            xm12_2_1Panding: this.xm12_2_1Panding.join(','),
            xm12_2_2Panding: this.xm12_2_2Panding.join(','),
            xm12_3Panding: this.xm12_3Panding.join(','),
            xm13_1Panding: this.xm13_1Panding.join(','),
            xm13_2Panding: this.xm13_2Panding.join(','),
            xm13_3Panding: this.xm13_3Panding.join(','),
          }), //表单序列化
      ...
      showPanding() {
        ...
        _objArray.forEach((item) => {
          this._sumary(item)
          this.zhege += this.t_zhege
          this.zbuhege += this.t_zbuhege
          this.zjibenhege += this.t_zjibenhege
          this.zbushiyong += this.t_zbushiyong
        })
      },
      //单项判定
      setMealSelect(e, obj, idNum) {
        ...
        //     topparent: '0',
        //     value: item.value,
        //     chilidren: item.children.length,
        //   }
        //   _objArray.push(_obj)
        //   firstLevel.push(_obj)
        //   item.children.forEach((subItem) => {
        //     _obj = {
        //       id: subItem.id,
        //       level: subItem.rank,
        //       parent: item.parentId,
        //       superparent: item.parentId,
        //       topparent: '0',
        //       value: subItem.value,
        //       chilidren: item.children.length,
        //     }
        //     if (subItem.children.length == 0) _pandingArray.push(_obj)
        //     _objArray.push(_obj)
        //     secondLevel.push(_obj)

        //     subItem.children.forEach((thirdItem) => {
        //       _obj = {
        //         id: thirdItem.id,
        //         level: thirdItem.rank,
        //         parent: thirdItem.parentId,
        //         superparent: subItem.parentId,
        //         topparent: '0',
        //         value: thirdItem.value,
        //         chilidren: item.children.length,
        //       }
        //       if (thirdItem.children.length == 0) _pandingArray.push(_obj)
        //       _objArray.push(_obj)
        //       thirdLevel.push(_obj)
        //     })
        //   })
        // })
        ...
        // let __pID = _myid.parent
        // let __sID = _myid.superparent
        // let __tID = _myid.topparent
        // console.log(idNum, __pID, __sID, __tID)
        // let __domID = 'id' + __pID
        // //如果有上级*****************************************
        // //首先查找自己的兄弟节点
        // //查找上级的兄弟节点，
        // //最后查找上上级的兄弟节点，计算其选中与否
        // let __IDsiblings = []
        // let __pIDsiblings = []
        // let __sIDsiblings = []
        // _aObj.map((item) => {
        //   item.parent == __pID ? __pIDsiblings.push(item.id) : ''
        // })
        // if ($(`[class='leftSum ${__domID}']`).length != 0)
        //   $(`[class='leftSum ${__domID}']`).find('span').remove()
        // $(`[class='leftSum ${__domID}']`).append(
        //   ` <span class='countStyle'> 追加文本 </span>`
        // )
        // //**************************************************
        // if (__sID != '0') {
        //   //如果还有上上一级
        ...
        //   )
        // }
        // console.log(`[class='leftSum ${__domID}']`)
        // // console.log($(`.${idNum}`).find('.leftSum'))
        //this.showPanding()

        // console.log(_objArray[_index])
        let [
          _item1,
          _item2,
          _item3,
      ...
      // 点击导航菜单,页面滚动到指定位置
      handleLeft(index) {
        if (this.$refs[`xm${index}`]) {
          let xmArray = [1, 4, 13, 21, 35, 44, 60, 72, 96, 102, 106, 112]
          let xmHeight = []
          xmArray.forEach((_index) => {
            console.log(this.$refs[`xm${_index}`])
            xmHeight.push(this.$refs[`xm${_index}`].offsetTop)
            xmHeight.push(this.$refs[`xm${_index}`].offsetHeight)
          })
          ...
          if (_ind.length >= 1)
            _ind.forEach((_index) => {
              console.log(_index)
              offset += this.$refs[`xm${_index}`].offsetHeight
            })
          let xiuzheng = 0
          let _tempIndex =
            index >= 112
          ...
          Number(index) > 4
            ? xmArray.indexOf(Number(index)) == -1
              ? (xiuzheng += 40)
              : ''
            : ''

          offset +=
            Number(this.$refs[`xm${index}`].offsetTop) +
            _ind.length * _ind.length * 10 +
            xiuzheng +
            showSelectedItemsHight
          console.log('offset')
          console.log(offset)
          console.log('xiuzheng')
          console.log(xiuzheng)
          console.log('index')
          console.log(index)
          console.log('----------')
          console.log(_ind.length)
      ...
      setIds(_id) {
        ...
        switch (id) {
          case '1':
            this.id1 = this.id2 = this.id3 = true
            break
          case '2':
            this.id1 = this.id2 = true
            break
          case '3':
            this.id1 = this.id3 = true
            break
          case '4':
            this.id4 =
              this.id5 =
