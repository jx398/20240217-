  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="设备编号" prop="SB_BianHao">
        <el-input v-model.trim="form.SB_BianHao"></el-input>
      </el-form-item>

      <el-form-item label="设备名称" prop="SB_Name">
        <el-input v-model.trim="form.SB_Name"></el-input>
      </el-form-item>

      <el-form-item label="设备型号" prop="SB_XingHao">
        <el-input v-model.trim="form.SB_XingHao"></el-input>
      </el-form-item>
      <el-form-item label="设备精度" prop="SB_JingDu">
        <el-input v-model.trim="form.SB_JingDu"></el-input>
      </el-form-item>
      <el-form-item label="设备数量" prop="SB_ShuLiang">
        <el-input v-model.trim="form.SB_ShuLiang"></el-input>
      </el-form-item>
      <el-form-item label="完好情况" prop="SB_ZhuangTai">
        <el-input v-model.trim="form.SB_ZhuangTai"></el-input>
      </el-form-item>
    </el-form>
