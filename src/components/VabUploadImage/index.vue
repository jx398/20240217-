<template>
  ...
  >
    <div class="upload">
      <el-alert
        :closable="false"
        :title="`支持${accept}格式，单次可最多选择${limit}张图片，每张不可大于${size}M，如果大于${size}M会自动为您过滤`"
        type="info"
      ></el-alert>
      <br />
      <el-upload
  ...
  export default {
    ...
    data() {
      return {
        ...
        dialogVisible: false,
        dialogImageUrl: '',
        action: 'http://117.160.199.82:7777/anbiao_bg.ashx?type=uploadImage',
        headers: {},
        fileList: [],
        picture: 'picture',
        imgNum: 0,
    ...
    methods: {
      ...
      handleClose() {
        this.$emit('changePS_Pics', {
          type: this.filefenlei,
          urls: this.fileList,
        })
